...
import com.brainoptimax.peakmeup.databinding.ItemRemindersBinding
...
class ReminderAdapter(var context: Context) : RecyclerView.Adapter<ReminderAdapter.ViewHolder>(){
