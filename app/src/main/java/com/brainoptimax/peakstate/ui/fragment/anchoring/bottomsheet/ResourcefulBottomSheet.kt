package com.brainoptimax.peakstate.ui.fragment.anchoring.bottomsheet
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ivAdd.setOnClickListener {
            ...
            if (getEditText.isEmpty()){
                ...
                viewModel.addResourceful(databaseReference, view, id!!, getEditText)
