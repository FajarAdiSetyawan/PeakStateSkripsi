...
import com.brainoptimax.peakmeup.databinding.ActivityReminderBinding
...
class ReminderActivity : AppCompatActivity() {
    ...
    private var activityReminderBinding: ActivityReminderBinding? = null
    private val binding get() = activityReminderBinding!!
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityReminderBinding = ActivityReminderBinding.inflate(layoutInflater)
