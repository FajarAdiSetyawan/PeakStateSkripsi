...
import com.brainoptimax.peakstate.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        animation.setAnimation(Bounce.InUp(binding.tvRegisterNow))
        animation.start()
    ...
    private fun login(email: String, password: String) {
        ...
        auth.signInWithEmailAndPassword(email, password).addOnCompleteListener {
            if (it.isSuccessful) {
                ...
                finish()
                Animatoo.animateZoom(this) // the zoom animation
            } else {
                // tampilkan dialog error
                alertDialogLoading.dismiss() // dialog loading hilang
