...
class ReminderService: Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val databaseHandler = ReminderDatabaseHandler(this)
    ...
    private fun showAlarmNotification(reminder: Reminders) {
        ...
        val notificationIntent = Intent(applicationContext, ListRemindersActivity::class.java)
