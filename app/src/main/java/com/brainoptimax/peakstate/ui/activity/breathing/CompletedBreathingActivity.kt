package com.brainoptimax.peakstate.ui.activity.breathing
...
import com.brainoptimax.peakstate.databinding.ActivityCompletedBreathingBinding
...
class CompletedBreathingActivity : AppCompatActivity() {
    ...
    fun performAnimation(im: ImageView?, f: Float, timer: Int) {
